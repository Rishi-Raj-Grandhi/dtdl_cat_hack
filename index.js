export function Drive_component(Brake_control, Transminssion_pressure, Pedal_sensor) {
...
export function Engine_component(Engine_oil_pressure, Engine_speed, Engine_temp) {
...
export function Fuel_component(Fuel_level, Fuel_pressure, Fuel_temperature, Water_fuel) {
    let Fuel_level_xx;
...
export function Misc_component(Air_filter_pressure, Exhaust_gas_temp, Hydraulic_pump_rate, System_voltage) {
